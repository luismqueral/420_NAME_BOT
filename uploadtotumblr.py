...
BLOGNAME='420-name-bot' #If your tumblr is foobar.tumblr.com, your blogname is "foobar" 
...
POEM_PATH='/Users/luis/Dropbox/Public/projects/420_NAME_BOT'
USETIMEDELTA=True
TIMEDELTA=timedelta(minutes=60) #For this to work, the timezone of your Tumblr-account needs to be set correctly, and your system time should be accurate
...
print '\033[1m' + '\n     observing {0} now!'.format(POEM_PATH) + '\033[0m'
observer.start()
